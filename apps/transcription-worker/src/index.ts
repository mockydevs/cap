...
import { prepareProviderRunMerge, type ConsentBasis } from "@cap/transcription";
...
async function processJob(job: Job<TranscriptionJob>) {
...
let ready = false;
const worker = new Worker<TranscriptionJob>(TRANSCRIPTION_QUEUE, processJob, {
  connection,
